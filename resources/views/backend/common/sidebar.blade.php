                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="add-plan.html" class="slide-item">Add Plan</a></li>
                                    <li><a href="all-plans.html" class="slide-item">All Plans</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="all-orders.html">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="all-messages.html">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Contact Me</span><i class="angle fa fa-angle-right"></i>
                                </a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Contact Me</a></li>
                                    <li><a href="add-contact-me.html" class="slide-item">Add</a></li>
                                    <li><a href="show-contact-me.html" class="slide-item">Show</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="add-social-links.html" class="slide-item">Add</a></li>
                                    <li><a href="show-social-links.html" class="slide-item">Show</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="add-privacy-policy.html" class="slide-item">Add</a></li>
                                    <li><a href="show-privacy-policy.html" class="slide-item">Show</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href="add-about-us.html" class="slide-item">Add</a></li>
                                    <li><a href="show-about-us.html" class="slide-item">Show</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
